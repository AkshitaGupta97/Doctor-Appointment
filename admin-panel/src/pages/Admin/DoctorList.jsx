...
const DoctorList = () => {
  ...
  const {doctors, adToken, getAllDoctorList} = useContext(AdminContext);
  ...
  return (
    <div className="m-5 max-h-[90vh]">
      ...
      <div className="flex w-full mt-4 shadow-lg shadow-gray-800 p-2 rounded-2xl flex-wrap gap-2 overflow-y-auto h-[80vh] pt-4 gap-y-6">
        {
          doctors.map((doctor) => (
            <div className="border p-4 mb-4 cursor-pointer flex items-center md:flex-col gap-4  border-blue-800 hover:scale-90 transition-all duration-300 shadow-lg shadow-emerald-950 rounded-3xl overflow-hidden w-full md:w-[48%] lg:w-[31%]"
               key={doctor._id} >
              ...
              <div className="flex flex-col justify-center items-center gap-1">
                ...
                <div>
                  <input type="checkbox" checked={doctor.available} className="mr-2 h-3.5 w-5 accent-cyan-900 cursor-pointer" />
                  <label className="text-green-900">Available</label>
                </div>
